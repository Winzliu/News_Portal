...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Merienda+One&family=Noto+Serif&display=swap"
      rel="stylesheet"
    />
  </head>
  ...
  <body style="font-family: 'Noto serif', serif" class="bg-light">
    ...
    <h1
      class="mt-5 fw-bolder text-center"
      style="font-size: 60px; font-family: 'Merienda One', cursive"
    >
      Beranda
    </h1>
    ...
    <div class="container d-flex flex-wrap mt-5">
      <!-- kategori -->
      <button
        class="mt-5 rounded-5 border-0 m-auto bg-light shadow-lg"
        style="min-width: 250px; height: 150px"
      >
        <a href="../KelolaKategori/" class="row text-decoration-none text-dark">
          ...
          <div class="card-body col-5 m-auto">
            <h1
              class="card-title"
              style="font-size: 60px; color: rgb(255, 208, 121)"
            >
      ...
      >
        <a href="../kelolaBerita/" class="row text-decoration-none text-dark">
          ...
          <div class="card-body col-5 m-auto">
            <h1
              class="card-title"
              style="font-size: 60px; color: rgb(112, 211, 117)"
            >
      ...
      >
        <a
          href="../kelolaKomentar/"
          class="row ms-1 text-decoration-none text-dark"
        >
          <div class="card-body col-7 m-auto">
          ...
          <div class="card-body col-5 m-auto">
            <h1
              class="card-title"
              style="font-size: 60px; color: rgb(255, 154, 136)"
            >
      ...
      >
        ...
        >
          <div class="card-body col-7 m-auto">
            <h3 class="card-title fw-bolder mb-2">Balasan</h3>
            <p class="card-text fw-bolder fs-1">
              <?php echo $balasan->num_rows; ?>
            </p>
          </div>
          <div class="card-body col-5 m-auto">
            <h1
              class="card-title"
              style="font-size: 60px; color: rgb(255, 110, 110)"
            >
      ...
      <!-- user -->
      <button
        class="my-5 rounded-5 border-0 m-auto bg-light shadow-lg"
        style="min-width: 250px; height: 150px"
      >
        <a href="../KelolaUser/" class="row text-decoration-none text-dark">
          ...
          <div class="card-body col-5 m-auto">
            <h1
              class="card-title"
              style="font-size: 60px; color: rgb(58, 77, 255)"
            >
